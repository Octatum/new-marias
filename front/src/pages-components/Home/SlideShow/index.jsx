...
const SlideshowSection = React.forwardRef((props, forwardedRef) => {    
    const images = [
        ...
        {title: "ok2", backgroundImage: "https://www.tourinews.es/uploads/s1/16/86/27/paisaje-2_4_732x400.jpeg"},
        {title: "ok3", backgroundImage: "https://www.lifeder.com/wp-content/uploads/2017/07/paisaje-cultural.jpg"},
    ]
