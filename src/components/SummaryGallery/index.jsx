...
class SummaryGallery extends Component {
    ...
    render(){
        return (
            <Container>
                <Button onClick={() => {this.previousImageHandler(); this.props.previousHandler()}} src={backButtonImg}/>
                <ImageContainer>
                    <Image src={this.props.images[this.state.currentImageIndex]}/>
                </ImageContainer>
                <Button onClick={() => {this.nextImageHandler(); this.props.nextHandler()}} src={forwardButtonImg}/>
            </Container>
        )
    }
}
